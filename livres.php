<?php 
    ...
    $request = "SELECT * FROM dn_objets WHERE dn_objets.Categorie IN (3, 4, 5, 6) GROUP BY Titre";
        ...
        <main>
            <div class="wrap">
                ...
                <?php if(isset($livre_succes)) {?>
                    <span class="succes"><?php echo $livre_succes ?></span>
                <?php } if(isset($livre_error)) {?>
                    <span class="error" ><?php echo $livre_error ?></span>
                <?php } ?>
                <div class="produits">
                ...
                <?php foreach($dn_objets as $dn_objet): ?>
                    <div class="object">
                        ...
                        <div class="text">
                            ...
                            <span class="infos"><?php echo $dn_objet['Date_sortie']; ?> - <?php echo $dn_objet['Style']; ?> - <?php echo $dn_objet['Auteur']; ?></span>
                        ...
                        <?php
                            $request = "SELECT Etat, id, Disponibilite  FROM dn_objets WHERE Titre = '{$dn_objet['Titre']}' AND (dn_objets.Categorie = 3 OR dn_objets.Categorie = 4 OR dn_objets.Categorie = 5 OR dn_objets.Categorie = 6)";
