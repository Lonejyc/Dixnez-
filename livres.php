        ...
        <main>
            <div class="wrap">
                ...
                <div class="object">
                    ...
                    <?php
                        $request = "SELECT Etat FROM dn_objets WHERE Titre = '{$dn_objet['Titre']}' AND (dn_objets.Categorie = 3 OR dn_objets.Categorie = 4  OR dn_objets.Categorie = 5 OR dn_objets.Categorie = 6)";
