<?php 
    ...
    $request = "SELECT * FROM dn_objets WHERE dn_objets.Categorie IN (9) GROUP BY Titre";
        ...
        if (isset($_POST['action'])) {
            ...
            if ($action === 'Emprunter') {
                ...
                if ($result_rendu) {
                    ...
                    if ($verif == '1') {
                        $multi_succes = "L'objet' a bien été rendu";
                        $result = mysqli_query($CONNEXION, $sql_update);
                    } else {
                        $multi_error = "Vous n'avez pas emprunté cet objet";
                    }
                }
            }
        }
    ...
    <body>
        ...
        <main>
            <div class="wrap">
                ...
                <?php if(isset($multi_succes)) {?>
                    <span class="succes"><?php echo $multi_succes ?></span>
                <?php } if(isset($livre_error)) {?>
                    <span class="error" ><?php echo $multi_error ?></span>
                <?php } ?>
                <div class="produits">
                ...
                <?php foreach($dn_objets as $dn_objet): ?>
                    <div class="object">
                        ...
                        <div class="text">
                            ...
                            <span class="resume">Description - <?php echo $dn_objet['Description']; ?></span>
                            <span class="quantite">
                        ...
                        <?php
                            $request = "SELECT Etat, id, Disponibilite  FROM dn_objets WHERE Titre = '{$dn_objet['Titre']}' AND (dn_objets.Categorie = 9)";
